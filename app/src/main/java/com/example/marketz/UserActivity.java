        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_cart:
                        Toast.makeText(UserActivity.this, "Cart selected", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.nav_orders:
                        Toast.makeText(UserActivity.this, "Orders selected", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.nav_category:
                        Toast.makeText(UserActivity.this, "Category selected", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.nav_settings:
                        Toast.makeText(UserActivity.this, "Settings selected", Toast.LENGTH_SHORT).show();
                        break;
